...
public abstract class WebSocketConfig extends AbstractWebSocketMessageBrokerConfigurer {
	...
	public void registerStompEndpoint(StompEndpointRegistry registry){
		logger.debug("Starting method registerStompEndpoint");
		registry.addEndpoint("/chat").withSockJS();
		registry.addEndpoint("chat_forum").withSockJS();
		logger.debug("Ending method registerStompEndpoint");
	}
